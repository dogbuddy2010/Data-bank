...
- AI Help also scans the program’s own functions/docstrings at startup to answer broader free-form questions
- AI Help uses weighted natural-language intent scoring (not only exact command phrases)
